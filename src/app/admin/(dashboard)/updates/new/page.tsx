...
export default function NewUpdatePage() {
  ...
  const [changelog, setChangelog] = useState<{ text: string; highlight: boolean }[]>([]);
  ...
  return (
    <div>
      <h1 className="font-serif text-2xl text-[#3D2B1F] mb-8">发动态</h1>
      ...
      <form action={formAction} className="space-y-6 max-w-2xl">
        ...
        <div>
          ...
          <MultiImageUploader name="photos" />
        </div>
